...
/**
 * Simulates an interactive treasurehunting experience
 */
public class TreasureHunt extends PApplet {
  ...
  public static void main(String[] args) {
    ...
    // do not add any other statement to the main method
  ...
  protected InteractiveObject findObjectByName(String name) {
    for (int i = 0; i < gameObjects.size(); i++) {
      if (gameObjects.get(i) instanceof InteractiveObject) {
        if (((InteractiveObject) gameObjects.get(i)).hasName(name))//cast to ensure is an
          // interactive object
  ...
  @Override
  public void draw() {
    image(backgroundImage, 0, 0); //draw background image to (0, 0) of this display window
    for (int i = 0; i < gameObjects.size(); i++) { //draw all clickable objects
  ...
  public void mousePressed() {
    // traverse the list of gameObjects and call mousePressed() on each object stored in the list
    for (int i = 0; i < gameObjects.size(); i++) {
  ...
  public void mouseReleased() {
    ...
    //traverse the list of gameObjects and call mouseReleased() method of each object stored in
    // the list
  }
